<div id="headerMiddle">
	...
	<div id="userlogin">
		...
		<a title="Create an Account" href="https://www.livingdirect.com/on/demandware.store/Sites-LD-Site/default/Login-Register">My Account</a>&nbsp; | &nbsp;
		...
		<a title="View Cart" href="https://www.livingdirect.com/on/demandware.store/Sites-LD-Site/default/Cart-Show">2
		</a>
	</div>
		...
		<div class="inputContainer">
			<form name="search_form" action="<?php the_field('search_query_url', 'option'); ?>" method="get" role="search" id="SimpleSearchForm">
				<fieldset>
					...
					<input class="goButton" value="Search" type="submit" name="Submit">
				</fieldset>
			</form>
		</div><!-- inputContainer -->
</div>
